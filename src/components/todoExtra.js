...
class TodoExtra extends Component {
  render() {
    const { unfinishedTodoCount, changeFilter, filter, handleAllDel } = this.props.todo;
    return (
      <footer className="footer">
        ...
        <button className="clear-completed" onClick={handleAllDel}>Clear completed</button>
      </footer>
    );
  }
}
